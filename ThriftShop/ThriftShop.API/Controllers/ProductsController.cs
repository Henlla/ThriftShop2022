...
namespace ThriftShop.API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Product>>> GetProductPagination(int page)
        {
            ...
            var numberOfProduct = await unitOfWork.Product.GetAll(includeProperties: "Category,Size_Product,Color_Product,ProductImage");
        ...
        {
            return Ok(await unitOfWork.Product.GetAll(x => x.CategoryId == categoryId, includeProperties: "Category,Size_Product,Color_Product,ProductImage"));
        }
        ...
        {
            var model = await unitOfWork.Product.GetAll(x => x.Brand == brandName, includeProperties: "Category,Size_Product,Color_Product,ProductImage");
            return Ok(model);
        }
        ...
        public async Task<ActionResult<IEnumerable<Product>>> GetProductByCreatedDate(string createdDateFromClient) // (yyyy-MM-dd format)
        {
            ...
            return Ok(await unitOfWork.Product.GetAll(x => x.CreatedDate.ToString() == createdDateFromClient, includeProperties: "Category,Size_Product,Color_Product,ProductImage"));
        }
        ...
        {
            return Ok(await unitOfWork.Product.GetAll(x => x.Price >= fromPrice && x.Price <= toPrice, includeProperties: "Category,Size_Product,Color_Product,ProductImage"));
        }
